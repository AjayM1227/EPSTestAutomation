...
namespace EPS.Automation
{
    ...
    public class CustomReport
    {
        ...
        static CustomReport()
        {
            ...
            report.AddSystemInfo("ApplicationURL", ConfigurationManager.AppSettings["MOLApplicationURL"]);
        ...
        private static String GetCustomReportHTMLFilePath()
        {
            ...
            var reportFilePath = Path.Combine(new string[] {
                                                   ...
                                                   GetDirectories("TestResults")[0].FullName,
                                                   ConfigurationManager.AppSettings["ProductName"].ToUpper()+
                                                   ...
                                                   AutomationConfigurationManagerResource.ReportName+
