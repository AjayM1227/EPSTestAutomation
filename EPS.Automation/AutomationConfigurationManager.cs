    ...
    class AutomationConfigurationManager
    {
       ...
       /// <summary>
        ...
        public static string GetApplicationUrltRoot()
        {
            ...
            switch (productName)
            {
                ...
                case "UAT":
                    //productURL = AutomationConfigurationManagerResource.MOL_UAT_URL;
                    //applicationUrl = string.Format(productURL, environment);
                    break;
      ...
      */
        ...
        public static string TestDataPath
        {
            get
            {
                return Environment.GetEnvironmentVariable(AutomationConfigurationManagerResource.TESTDATA_PATH_Key)
